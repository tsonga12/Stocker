...
public class OrderFailureActivity extends AppCompatActivity implements ObjectFailureActivity {
    ...
    public void onNewObjectClick(View v){
        ...
        Intent showActivityOrderNew = new Intent(this, OrderNewActivity.class);
        startActivity(showActivityOrderNew);
